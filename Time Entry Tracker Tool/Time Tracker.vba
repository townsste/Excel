...
Private Sub addCurrentForm_Click()
    If overrideStatus = True And Me.override1Box = False And Me.override2Box = False And Me.override3Box = False And Me.override4Box = False Then
        errorOverrideHandle
    Else
...
Private Sub overrideOverride()
    If override1Box = True Then
        overrideNumber = 1
        Me.statusBox.Caption = "ADD_OVERIDE_TITLE_1"
    ElseIf override2Box = True Then
        overrideNumber = 2
        Me.statusBox.Caption = "ADD_OVERIDE_TITLE_2"
    ElseIf override3Box = True Then
        overrideNumber = 3
        Me.statusBox.Caption = "ADD_OVERIDE_TITLE_3"
    ElseIf override4Box = True Then
        overrideNumber = 4
        Me.statusBox.Caption = "ADD_OVERIDE_TITLE_4"
    End If
End Sub
...
Public Sub setValues()
    ...
    'Place data in specified location
        ...
        .Cells(lRow, 10).Value = "=TEXT(IF(I" + lRow + "= 1,D" + lRow + "+6, IF(I" + lRow + "= 2, D" + lRow + "+5, IF(I" + lRow + "= 3,D" + lRow + "+4, IF(I" + lRow + "= 4, D" + lRow + "+3, IF(I" + lRow + "= 5, D" + lRow + "+2, IF(I" + lRow + "= 6, D" + lRow + "+1, IF(I" + lRow + "=7,D" + lRow + "+0)))))))," + Chr(34) + "mm/dd" + Chr(34) + ")"
